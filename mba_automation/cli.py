...
def main():
    ...
    with sync_playwright() as playwright:
        for phone in phones:
            print(f"Starting automation for {phone}")
            automation_run(playwright, phone=phone, password=password, headless=args.headless, slow_mo=args.slow_mo, iterations=args.iterations, review_text=args.review)
